...
// 相差几天
console.log(moment().diff(moment().subtract(1, "days"), "days"));
console.log(moment().diff(moment().add(1, "days"), "days"));
...
console.log(
  "一小时之前",
  moment().subtract(1, "hours").format("YYYY-MM-DD HH:00")
); // 一小时之前
console.log(
  "一小时之后",
  moment().add(1, "hours").format("YYYY-MM-DD HH:00:00")
); // 一小时之后, 保留小时分秒 补 00
...
// 一小时之前
new Date(new Date().setTime(new Date().getTime() - 1000 * 60 * 60 * 1 * 1));
